...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(document).ready(function () {
	    ...
	    var icon = document.querySelector('.fa-smile');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EmojiCategory = __webpack_require__(6);

	var _EmojiCategory2 = _interopRequireDefault(_EmojiCategory);

	var _rmTooltip = __webpack_require__(8);
	...
	var EmojiPicker = function () {
	    ...
	    _createClass(EmojiPicker, [{
	        ...
	        value: function openPicker() {
	            ...
	            switch (_defaults2.default.positioning) {
	                case "autoplace":
	        ...
	        value: function _setDefaults(options) {
	            ...
	            keys.forEach(function (key) {
	                if (_defaults2.default.hasOwnProperty(key)) {
	                    _defaults2.default[key] = options[key];
	                }
	            });
	        }
	        ...
	        value: function _getCategories() {
	            return _defaults2.default.categories.map(function (cat) {
	                return new _EmojiCategory2.default(cat, _data2.default[cat.title]);
	            });
	        }
	        ...
	        value: function _onIconClick() {
	            ...
	            (0, _jquery2.default)(this._icon).off('click.emoji-picker').on('click.emoji-picker', function (event) {
	                _this2.picker_open = !_this2.picker_open;
	            });
	        ...
	        value: function _onTooltipClick(tooltip, event) {
	            ...
	            tooltip.setClickCallback(event, function (target, $tooltip) {
	                ...
	                var is_icon = (0, _jquery2.default)(target).is(_this3._icon);

	                //If the click occurred outside of the tooltip
	                if (!$picker.length && !is_icon) {
	                    _this3.picker_open = false;
	                }
	            });
	        }
	    }], [{
	...
	var EmojiCategory = function () {
	    function EmojiCategory(category, data) {
	        ...
	        this.emojis = data.map(function (emote) {
	            return new _Emoji2.default(emote);
	        });
	...
	var Emoji = function () {
	  ...
	  _createClass(Emoji, [{
	    ...
	    value: function getUnified() {
	      var converter = _Converters2.default.factory();
	    ...
	    value: function getEmojiForPlatform() {
	      var converter = _Converters2.default.factory();
	      var emote = converter.withEnvironment().replace_colons(this.getColons());

	      var $emote = (0, _jquery2.default)(emote);

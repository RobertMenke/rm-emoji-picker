	  ...
	  return function (e) {
	    ...
	    function o(e) {
	      ...
	      function e() {
	        var _ = this,
	          ...
	          } }), this.active_category = this.categories[0], this._onScroll()._onCatClick()._onSearch();
	          ...
	          var o = O.default.events;switch (e) {case o.SELECTED:
	          ...
	          var e = (0, r.default)((0, A.default)({ default_content: O.default.default_footer_message, categories: this.categories.map(function (e) {
	          ...
	          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : void 0;e = e || O.default.sheets, p.default.setSheets(e);
	        } }]), e;
	    }();_.default = T;
	  }, function (_, a) {
	    _.exports = e;
	    ...
	    function o(e) {
	      ...
	      function e(_) {
	        var a = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];s(this, e), this._input = _, this._is_content_editable = _.isContentEditable, this.cursor_position = void 0, this.prevent_new_line = a, this._trackCursor(), this._onPaste();
	          ...
	          var a = this,
	            ...
	            var o = _ instanceof Text,
	                s = _ instanceof HTMLElement;return o ? _.textContent : s && "SPAN" === _.tagName ? e._extractSpan(_) : s && "BR" === _.tagName ? "\n" : s ? a._mapElement(_) : "";
	          }).join("");
	        ...
	        } }], [{ key: "_extractSpan", value: function value(e) {
	          var _ = (0, m.default)(e),
	              a = _.find(".emoji-inner");if (!a.length) return "";try {
	            var o = a.data("codepoints");return String.fromCodePoint("0x" + o);
	          } catch (e) {
	            return "";
	          }
	    ...
	    function o(e) {
	      ...
	      function e() {
	        s(this, e), this.unicode = e.unified, this.env = e.environment, this.css = e.image, g.default.use_sheets && this.setSheets(g.default.sheets);
	          ...
	          var e = new m.default();return e.init_env(), "css" === e.replace_mode && (e.replace_mode = "css"), e;
	    ...
	    !function (e) {
	      function _(e) {
	        ...
	        var r = [],
	          ...
	          if (n = _.shift(), h && "<" == h.tag && !(n.tag in I)) throw new Error("Illegal content in < super tag.");if (e.tags[n.tag] <= e.tags.$ || t(n, m)) o.push(n), n.nodes = s(_, n.tag, o, m);else {
	            if ("/" == n.tag) {
	        ...
	        return "t.b(" + e + ");";
	          ...
	          w = /\\/g,
	          u = /\u2028/,
	          O = /\u2029/;e.tags = { "#": 1, "^": 2, "<": 3, $: 4, "/": 5, "!": 6, ">": 7, "=": 8, _v: 9, "{": 10, "&": 11, _t: 12 }, e.scan = function (s, t) {
	        function i() {
	          ...
	          var o = "=" + R,
	            ...
	            A = 0,
	            T = "{{",
	            R = "}}";for (t && (t = t.split(" "), T = t[0], R = t[1]), I = 0; I < h; I++) {
	          d == n ? o(T, s, I) ? (--I, i(), d = l) : "\n" == s.charAt(I) ? r(O) : w += s.charAt(I) : d == l ? (I += T.length - 1, E = e.tags[s.charAt(I + 1)], c = E ? s.charAt(I + 1) : "_v", "=" == c ? (I = g(s, I), d = n) : (E && I++, d = f), O = I) : o(R, s, I) ? (u.push({ tag: c, n: a(w), otag: T, ctag: R, i: "/" == c ? O - T.length : I + R.length }), w = "", I += R.length - 1, d = n, "{" == c && ("}}" == R ? I++ : _(u[u.length - 1]))) : w += s.charAt(I);
	        }return r(O, !0), u;
	    ...
	    var o = a(9);e.exports = function () {
	      var e = new o.Template({ code: function code(e, _, a) {
	          ...
	          }), e.pop()), o.b('</div><div class="emoji-section emoji-search"><div class="search-wrapper"><div class="search-section centered"><i class="fa fa-search" aria-hidden="true"></i></div><div class="search-section input"><input class="search-emojis" placeholder="Search"></div></div></div><div class="emoji-title-overlay"><span id="active-title"></span></div><div class="emoji-section emoji-content"></div><div class="emoji-section emoji-footer"><div class="default-content"><span>'), o.b(o.v(o.f("default_content", e, _, 0))), o.b('</span></div><div class="emoji-preview"><div class="preview-section" id="emoji-large-preview"></div><div class="preview-section"><span id="emoji-name"></span> <span id="colon-display"></span></div></div></div></div>'), o.fl();
	        }, partials: {}, subs: {} }, '<div id="emoji-picker"><div class="emoji-section emoji-header">{{#categories}}<div class="select-category" data-name="{{title}}">{{{icon}}}</div>{{/categories}}</div><div class="emoji-section emoji-search"><div class="search-wrapper"><div class="search-section centered"><i class="fa fa-search" aria-hidden="true"></i></div><div class="search-section input"><input class="search-emojis" placeholder="Search"></div></div></div><div class="emoji-title-overlay"><span id="active-title"></span></div><div class="emoji-section emoji-content"></div><div class="emoji-section emoji-footer"><div class="default-content"><span>{{default_content}}</span></div><div class="emoji-preview"><div class="preview-section" id="emoji-large-preview"></div><div class="preview-section"><span id="emoji-name"></span> <span id="colon-display"></span></div></div></div></div>', o);return e.render.apply(e, arguments);
	    };
	  }, function (e, _) {
	    "use strict";
